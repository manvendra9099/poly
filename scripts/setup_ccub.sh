...
echo ""
echo "Next steps:"
echo "  1. Edit the FILL IN fields in the qsub scripts:"
echo "       nano scripts/qsub/smoketest_gpu.sh"
echo "       nano scripts/qsub/train_default.sh"
echo ""
echo "  2. Run the 30-min GPU smoke-test (sanity check before full run):"
echo "       qsub scripts/qsub/smoketest_gpu.sh"
echo ""
